        ...
        if (this.$.app) {
            ...
            app.component('MyProject', defineComponent({
                ...
                methods: {
                    filterExcel() {
                        let files: IFileData[] = [];
                        if (this.excelPath && existsSync(this.excelPath)) {
                    ...
                    changeExportPathConfig(isUse: boolean) {
                        ...
                        if (this.useExportPathConfig) {
                            ...
                            if (existsSync(configPath)) {
                                let { exportPath, exportTSPath, excelPath } = JSON.parse(readFileSync(configPath, 'utf-8'));
                    ...
                    saveExportPathConfig() {
                        ...
                        let configPath = join(__dirname, '../../../static/ExportPathConfig.json');
                        writeFileSync(configPath, JSON.stringify(exportPathConfig, null, '\t'));
                    },
                    refreshFiles() {
